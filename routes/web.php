...
// ==========================================
// PELANGGAN — PUBLIC (tidak perlu login)
// ==========================================
...
Route::name('pelanggan.')->group(function () {
    ...
    // Voucher info boleh diakses tanpa login (untuk preview diskon)
    Route::get('/akun/voucher/info', function (\Illuminate\Http\Request $request) {
    ...
    // ==========================================
    // PELANGGAN — PRIVATE (wajib login)
    // ==========================================
    Route::prefix('akun')->middleware('auth')->group(function () {

        // Profil
        Route::get('/profil', fn() => view('pelanggan.profil-edit'))->name('profil-edit');
        Route::put('/profil/simpan', [CustomerProfileController::class, 'update'])->name('profil.simpan');

        // Password
        Route::get('/password', fn() => view('pelanggan.profil-password'))->name('profil-password');
        Route::put('/password/simpan', [CustomerProfileController::class, 'updatePassword'])->name('ganti-password.simpan');
...
// ==========================================
Route::get('/checkout/success', fn() => view('pelanggan.payment-confirm'))->name('pelanggan.checkout.success');
Route::get('/checkout/failed', fn() => view('pelanggan.payment-failed'))->name('checkout.failed');


// ==========================================
// HELP & SUPPORT
// ==========================================
Route::get('/help', fn() => view('pelanggan.help'))->name('help');
Route::get('/help/shipping', fn() => view('pelanggan.shipping-information'))->name('help.shipping');
Route::get('/help/returns', fn() => view('pelanggan.returns-exchanges'))->name('help.returns');
Route::get('/help/size-guide', fn() => view('pelanggan.size-guide'))->name('help.size-guide');
Route::get('/help/faq', fn() => view('pelanggan.faq'))->name('help.faq');
