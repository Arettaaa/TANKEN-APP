...
<script>
    function showToast(msg, type = 'success') {
        ...
        setTimeout(() => { container.classList.remove('translate-y-0', 'opacity-100'); container.classList.add('translate-y-[-20px]', 'opacity-0'); setTimeout(() => container.classList.add('hidden'), 300); }, 2500);
    }
