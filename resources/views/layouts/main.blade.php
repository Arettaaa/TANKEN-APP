        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-10 relative">
            <div class="flex items-center justify-between h-14 md:h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="{{ route('pelanggan.katalog') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Shop</a>
                    <a href="{{ route('women') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Women</a>
                    <a href="{{ route('men') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Men</a>
                    <a href="{{ route('help') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Help</a>
                </div>
