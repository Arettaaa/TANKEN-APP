    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-icon {
            ...
            padding-bottom: 3px; cursor: pointer; background: none; border: none; color: #111; transition: color 0.2s ease;
        }
        .nav-icon::after {
            content: ''; position: absolute; bottom: 0; left: 50%; transform: translateX(-50%);
            width: 0; height: 1.5px; background: #111; transition: width 0.22s ease;
        }
        ...
        .search-input-box {
            width: 0; opacity: 0; overflow: hidden; transition: width 0.35s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease;
            pointer-events: none;
        }
        .search-input-box.open { width: 180px; opacity: 1; pointer-events: all; }
        .search-input-box input {
            width: 100%; height: 32px; background: #f3f3f3; border: none; border-radius: 20px;
            padding: 0 14px; font-family: 'Inter', sans-serif; font-size: 0.8rem; color: #111; outline: none;
        }
...
<body class="font-body flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-10 relative">
            <div class="flex items-center justify-between h-14 md:h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ Route::has('pelanggan.katalog') ? route('pelanggan.katalog') : url('/katalog') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Shop</a>
                    <a href="{{ Route::has('women') ? route('women') : url('/women') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Women</a>
                    <a href="{{ Route::has('men') ? route('men') : url('/men') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Men</a>
                    <a href="{{ Route::has('help') ? route('help') : url('/help') }}" class="nav-link text-sm font-medium text-gray-800 hover:text-black">Help</a>
                </div>
                ...
                <div class="flex items-center gap-2 md:gap-5">
                    ...
                    {{-- Wishlist (Aman dari error route not defined) --}}
                    <a href="{{ Route::has('pelanggan.profil-wishlist') ? route('pelanggan.profil-wishlist') : url('/akun/wishlist') }}" class="nav-icon relative hidden md:inline-flex" aria-label="Wishlist">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" width="18" height="18">
                    ...
                    {{-- Cart (Aman dari error route not defined) --}}
                    <a href="{{ Route::has('keranjang.index') ? route('keranjang.index') : url('/keranjang') }}" class="nav-icon relative" aria-label="Keranjang" id="cart-btn">
                    ...
                    @guest
                    <a href="{{ Route::has('login') ? route('login') : url('/login') }}" class="nav-icon hidden md:inline-flex items-center gap-1.5 text-sm font-medium text-gray-800" style="padding-bottom:3px;">
                    ...
                    <div class="relative hidden md:flex items-center h-full group cursor-pointer">
                        ...
                        <div class="absolute right-0 top-[100%] pt-2 w-44 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="bg-white border border-gray-100 rounded-md shadow-lg py-1 overflow-hidden">
                                <a href="{{ Route::has('pelanggan.profil-edit') ? route('pelanggan.profil-edit') : url('/akun/profil') }}" class="block px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-black transition-colors">Akun Saya</a>
                                <a href="{{ Route::has('pelanggan.profil-order') ? route('pelanggan.profil-order') : url('/akun/pesanan') }}" class="block px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-black transition-colors">Pesanan Saya</a>
                    ...
                    @guest
                    <a href="{{ Route::has('login') ? route('login') : url('/login') }}" class="nav-icon md:hidden" aria-label="Masuk">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" width="18" height="18">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                        </svg>
                    ...
                    @else
                    <a href="{{ Route::has('pelanggan.profil-edit') ? route('pelanggan.profil-edit') : url('/akun/profil') }}" class="nav-icon md:hidden" aria-label="Akun Saya">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" width="18" height="18">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                        </svg>
            ...
            <div id="mobile-menu" class="hidden md:hidden absolute left-0 right-0 top-[100%] bg-white border-t border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.08)] z-[90]">
                <div class="px-5 py-5 flex flex-col gap-4">
                    ...
                    <div class="relative w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="16" height="16" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                            <circle cx="11" cy="11" r="8" />
                            <path d="m21 21-4.35-4.35" />
                        </svg>
                    ...
                    <a href="{{ Route::has('pelanggan.katalog') ? route('pelanggan.katalog') : url('/katalog') }}" class="text-sm font-medium text-gray-800 hover:text-black py-1">Shop</a>
                    <a href="{{ Route::has('women') ? route('women') : url('/women') }}" class="text-sm font-medium text-gray-800 hover:text-black py-1">Women</a>
                    <a href="{{ Route::has('men') ? route('men') : url('/men') }}" class="text-sm font-medium text-gray-800 hover:text-black py-1">Men</a>
                    <a href="{{ Route::has('help') ? route('help') : url('/help') }}" class="text-sm font-medium text-gray-800 hover:text-black py-1">Help</a>
                    <hr class="border-gray-100">

                    {{-- Wishlist Khusus Mobile --}}
                    <a href="{{ Route::has('pelanggan.profil-wishlist') ? route('pelanggan.profil-wishlist') : url('/akun/wishlist') }}" class="flex items-center justify-between text-sm font-medium text-gray-800 hover:text-black py-1">
                    ...
                    @guest
                    <a href="{{ Route::has('login') ? route('login') : url('/login') }}" class="flex items-center gap-2 text-sm font-medium text-gray-800 hover:text-black py-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" width="16" height="16">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                        </svg>
                    ...
                    @else
                    <a href="{{ Route::has('pelanggan.profil-edit') ? route('pelanggan.profil-edit') : url('/akun/profil') }}" class="flex items-center gap-2 text-sm font-medium text-gray-800 hover:text-black py-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" width="16" height="16">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                        </svg>
                    ...
                    <form method="POST" action="{{ Route::has('logout') ? route('logout') : url('/logout') }}" class="mt-1 pb-2">
                        @csrf
                ...
                <div class="sm:col-span-2 lg:col-span-4">
                    ...
                    <div class="mt-5 flex flex-col gap-3 text-sm text-gray-400">
                        <div class="flex items-start gap-2.5">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6" width="15" height="15" class="mt-0.5 flex-shrink-0">
                        ...
                        <div class="flex items-center gap-2.5">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6" width="15" height="15">
            ...
            <div class="mt-10 pt-8 border-t border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-6">
                <div class="w-full md:w-auto">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="#" class="w-10 h-10 md:w-9 md:h-9 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:border-white hover:text-white transition-colors">
    ...
    <script>
        ...
        function updateWishlistBadge() {
            ...
            if (totalItem > 0) {
                if (badgeDesktop) {
                    badgeDesktop.textContent = totalItem > 99 ? '99+' : totalItem;
                    badgeDesktop.classList.remove('hidden');
                }
                if (badgeMobile) {
                    badgeMobile.textContent = totalItem > 99 ? '99+' : totalItem;
