...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/logo-icon-tanken.png') }}">
                ...
                <div class="sm:col-span-2 lg:col-span-4">
                    ...
                    <div class="mt-5 flex flex-col gap-3 text-sm text-gray-400">
                        <div class="flex items-start gap-2.5">
                            ...
                            <a href="https://maps.app.goo.gl/xFMZ4Dfw6mFmzgYAA" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors">
                                Kota Bekasi, Jawa Barat, Indonesia
                            </a>
                        </div>
                        <a href="https://wa.me/6285121235200?text=Halo%20admin%20tanken%2C%20saya%20ingin...." target="_blank" class="flex items-center gap-2.5 hover:text-white transition-colors cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="1.6" width="15" height="15">
                                <path
