        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-10 relative">
            <div class="flex items-center justify-between h-14 md:h-16">
                ...
                <div class="flex items-center gap-2 md:gap-5">
                    ...
                    <a href="{{ route('pelanggan.profil-wishlist') ?? '#' }}"
                        ...
                        <span id="wishlist-badge-desktop"
                            class="absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center hidden">0</span>
                    </a>
                    ...
                    @else
                    <a href="{{ route('pelanggan.profil-edit') ?? '#' }}" class="nav-icon md:hidden"
