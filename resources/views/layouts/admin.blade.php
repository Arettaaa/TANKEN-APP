...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge-red    { @apply inline-flex px-2 py-0.5 text-xs font-semibold rounded-full bg-red-100 text-red-700; }
...
<aside id="admin-sidebar" class="w-52 flex-shrink-0 bg-admin-sidebar text-white flex flex-col h-screen overflow-y-auto">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 text-sm">
        ...
        {{-- Reviews --}}
        <a href="{{ route('admin.reviews.index') }}" class="sidebar-link flex items-center gap-3 pl-9 pr-3 py-2 rounded-lg text-gray-400 text-xs transition-colors {{ request()->routeIs('admin.reviews*') ? 'active' : '' }}">
...
<div class="flex-1 flex flex-col min-w-0 overflow-hidden">
    ...
    {{-- ====== TOPBAR ====== --}}
    <header class="bg-white border-b border-gray-200 h-14 flex items-center justify-between px-5 flex-shrink-0 z-20">
        ...
        <div class="flex items-center gap-4">
            {{-- Notification bell --}}
            <button class="relative text-gray-500 hover:text-black transition-colors">
                ...
                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center">2</span>
            </button>
            ...
            <div class="relative" id="admin-user-menu">
                <button onclick="toggleUserMenu()"
                    ...
                    <div class="w-8 h-8 rounded-full bg-gray-900 flex items-center justify-center flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.8" width="16" height="16">
    ...
    <main class="flex-1 overflow-y-auto p-5 md:p-6">
        ...
        {{-- Flash messages --}}
        @if(session('success'))
        <div class="mb-5 flex items-center gap-3 bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="16" height="16" class="flex-shrink-0">
        ...
        @if(session('error'))
        <div class="mb-5 flex items-center gap-3 bg-red-50 border border-red-200 text-red-800 text-sm px-4 py-3 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="16" height="16" class="flex-shrink-0">
