...
<div id="zoom-overlay"
     class="fixed inset-0 z-[60] hidden bg-black/90 backdrop-blur-sm"
            ...
            <div class="mb-5">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <button class="text-xs text-gray-400 underline hover:text-gray-700 transition-colors"
                            onclick="alert('Size guide modal — coming soon!')">
                        Size Guide
                    </button>
                </div>
...
@push('styles')
<style>
    .color-btn.active { border-color: #111 !important; background-color: #111; color: #fff; }
    .size-btn.active  { border-color: #111 !important; background-color: #111; color: #fff; }
    .thumb-btn.active { border-color: #111 !important; }
