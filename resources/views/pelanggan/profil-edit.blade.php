...
<style>
    ...
    /* Avatar */
    .avatar-circle { width: 56px; height: 56px; border-radius: 8px; background: #111; color: #fff; font-size: 1.4rem; font-weight: 800; display: flex; align-items: center; justify-content: center; }
            ...
            <aside class="w-full lg:w-64 flex-shrink-0">
                <div class="bg-white border border-gray-200 rounded-lg p-4 sm:p-5">
                    ...
                    <nav class="flex flex-row lg:flex-col lg:overflow-visible gap-2 lg:gap-1 pb-3 lg:pb-0 mobile-nav-scroll w-full">
                        ...
                        <a href="{{ route('pelanggan.ganti-password') }}" class="menu-item">
                        ...
                        <a href="{{ route('pelanggan.pesanan') }}" class="menu-item">
                        ...
                        <a href="{{ route('pelanggan.wishlist') }}" class="menu-item">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 sm:p-8">
                    ...
                    <div>
                        ...
                        <form action="{{ route('pelanggan.profil.simpan') }}" method="POST" class="flex flex-col gap-4 sm:gap-5">
                            ...
                            <div class="pt-2">
                                <button type="submit" class="w-full bg-gray-900 text-white text-[10px] sm:text-xs font-bold tracking-widest uppercase px-7 py-3.5 rounded-md hover:bg-gray-700 transition-colors shadow-sm">
                                    Simpan Perubahan
                                </button>
                            </div>
                        </form>
