...
@section('title', 'Masuk')
@section('left-title', 'Welcome Back')
@section('left-desc', 'Sign in to access your account and continue your journey with premium athletic wear.')
...
@section('content')
    ...
    <div class="mb-7">
        <h2 class="font-extrabold text-3xl text-gray-900 mb-1">Sign In</h2>
        <p class="text-sm text-gray-400 font-medium">Enter your credentials to continue</p>
    </div>
        ...
        <div>
            ...
            <div class="input-wrap">
                ...
                <button type="button" class="eye-toggle" onclick="togglePassword('loginPassword', this)">
                    ...
                    <svg id="loginPassword-eye-closed" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.7" width="17" height="17"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                    {{-- Hidden: Mata terbuka --}}
                    <svg id="loginPassword-eye-open" style="display:none;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.7" width="17" height="17"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                </button>
            </div>
        </div>
    ...
    <p class="text-center text-sm text-gray-500 mt-5">
        Don't have an account?&nbsp;<a href="{{ route('register') }}" class="font-bold text-gray-900 hover:underline">Sign up</a>
    </p>
